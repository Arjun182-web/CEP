...
import Layout from "../common/Layout"; // ✅ Make sure this path is correct
...
function AdminRegister() {
  ...
  const handleRegister = async (e) => {
    ...
    if (response.ok && result.includes("Admin registered")) {
  ...
  return (
    <Layout>
      <div style={outerContainer}>
        <div style={cardStyle}>
          <h2 style={headingStyle}>🛡️ Admin Register</h2>
